...
<div class="news_content_canvas">
	<form class="input_form_canvas" method="post" action="check_inputbook.php">
	 	<ul class="input_fr_list">
			...
			<li><label>昵称:</label><input  type="text" name="user" id="user"></input> </li>
			<li><label>电子邮箱:</label><input  type="email" name="email" id="email"></input> </li>
			<li><label>留言内容:</label>
				<textarea name="content" id="content" style="width:500px;height:200px;" placeholder="请输入留言内容！"></textarea>
			</li>
			<li><label>验证码: &nbsp;</label>
